const ButtonSvg = (white) => {
  if (white) {
    return <span className="absolute inset-0 rounded-lg bg-white" />;
  }
  ...
  return (
    ...
    >
      <path
        fill="none"
        stroke="url(#btn-left)" // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill="none"
        stroke="url(#btn-right)" // mentioned in ButtonGradient.jsx
        strokeWidth="2"
