...
export const passes = [
  {
    ...
    description: "A low-commitment balance for occasional protected trades",
    price: "10",
    creditAmount: 12,
    passCount: "$12 fee credit",
    features: [
      "$12 applied dollar-for-dollar to platform fees",
      "Save $2 compared with pay-as-you-go fees",
      "Instant activation upon purchase",
      "Works across every supported cryptocurrency",
      "Never expires; unused credit stays on your account",
    ],
  },
  {
    id: "1",
    title: "Trader Credits",
    description: "Best value for regular buyers, sellers, and freelancers",
    price: "25",
    creditAmount: 32,
    passCount: "$32 fee credit",
    features: [
      "$32 applied dollar-for-dollar to platform fees",
      "Save $7 compared with pay-as-you-go fees",
      "Instant activation upon purchase",
      "Can cover several trades or part of a larger fee",
      "Never expires; unused credit stays on your account",
    ],
  },
  {
    id: "2",
    title: "Rhino Credits",
    description: "Maximum value for businesses and high-volume traders",
    price: "50",
    creditAmount: 70,
    passCount: "$70 fee credit",
    features: [
      "$70 applied dollar-for-dollar to platform fees",
      "Save $20 compared with pay-as-you-go fees",
      "Instant activation upon purchase",
      "Designed for repeat and high-value transactions",
      "Never expires; unused credit stays on your account",
    ],
  },
];
...
export const benefits = [
  {
    id: "0",
    title: "About Us",
    text: "Assisted P2P crypto escrow with unique on-chain deposit addresses, confirmation tracking, controlled release, and human dispute support. Availability depends on the enabled asset and network.",
  ...
  },
  {
    id: "3",
    title: "Fees & Credits",
    text: "Transparent, value-based platform fees keep protected trading affordable. Prepaid credits reduce those fees dollar-for-dollar and reward repeat use.",
  ...
  },
  {
    id: "5",
    title: "Support",
    text: "Customer support via Discord and email for trades, technical issues, and account queries. Current response targets and service availability are shown in the support area.",
